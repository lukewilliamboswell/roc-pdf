...
SNAPSHOT = ROOT / "tests" / "gate3_soft_hyphen" / "snapshot.pdf"
...
def check_pdfbox_extraction(pdf: Path) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="roc-pdf-gate3-soft-hyphen-") as temporary_name:
    ...
    print("PASS Gate 3 PDFBox 3.0.8 extraction: selected soft hyphen remains source-preserving")
...
def self_test() -> None:
    ...
    print("PASS Gate 3 soft-hyphen structure and extraction checker self-test")
...
def main() -> None:
    ...
    print(f"PASS Gate 3 soft-hyphen structure, CID, and mapping checks: {pdf}")
