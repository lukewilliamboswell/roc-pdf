#!/usr/bin/env python3
"""Gate 4 navigation and link-annotation structural checker.
...
from check_gate4_forms import replace_once

ROOT = Path(__file__).resolve().parents[1]

SNAPSHOTS = {
    "showcase": ROOT / "tests" / "gate4_navigation" / "snapshot.pdf",
    "annots_8": ROOT / "tests" / "gate4_navigation_annots_8" / "snapshot.pdf",
    "annots_64": ROOT / "tests" / "gate4_navigation_annots_64" / "snapshot.pdf",
    "quads_32": ROOT / "tests" / "gate4_navigation_quads_32" / "snapshot.pdf",
    "share_32": ROOT / "tests" / "gate4_navigation_share_32" / "snapshot.pdf",
    "appearance_16": ROOT / "tests" / "gate4_navigation_appearance_16" / "snapshot.pdf",
    "outline_deep_16": ROOT / "tests" / "gate4_navigation_outline_deep_16" / "snapshot.pdf",
    "outline_wide_64": ROOT / "tests" / "gate4_navigation_outline_wide_64" / "snapshot.pdf",
    "names_8": ROOT / "tests" / "gate4_navigation_names_8" / "snapshot.pdf",
    "names_40": ROOT / "tests" / "gate4_navigation_names_40" / "snapshot.pdf",
    "labels_8": ROOT / "tests" / "gate4_navigation_labels_8" / "snapshot.pdf",
    "unique": ROOT / "tests" / "gate4_navigation_unique" / "snapshot.pdf",
    "retained": ROOT / "tests" / "gate4_navigation_retained" / "snapshot.pdf",
    "negative": ROOT / "tests" / "gate4_navigation_negative" / "snapshot.pdf",
    "facade": ROOT / "tests" / "gate4_navigation_facade" / "snapshot.pdf",
    "facade_negative": ROOT / "tests" / "gate4_navigation_facade_negative" / "snapshot.pdf",
}
...
def validate_gate4_navigation_pdf(pdf: bytes, dimensions: dict[str, int]) -> None:
    expectations = {
        key: dimensions[key]
...
def self_test() -> None:
    ...
    print(
        "PASS Gate 4 navigation structural checker self-test: paired /SD + /D "
