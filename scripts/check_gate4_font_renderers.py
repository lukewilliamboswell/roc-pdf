#!/usr/bin/env python3
"""Pinned renderer, extraction, and font-validator evidence for the Gate 4
canonical font-leaf fixtures.

Structural facts (``check_gate4_fonts.py``) are the primary oracle; this
...
from check_gate4_fonts import FontFacts
...
def check_renderers(renderer: Path, working_directory: Path | None, mutool: Path | None) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="roc-pdf-gate4-font-render-") as temporary_name:
    ...
    print(
        "PASS Gate 4 font-leaf renderers: PDFium Chromium 7988 and PDFBox 3.0.8 ink every declared "
...
def self_test() -> None:
    ...
    print("PASS Gate 4 font-leaf renderer checker self-test")
