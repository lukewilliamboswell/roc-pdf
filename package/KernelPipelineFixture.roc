...
build_pipeline = |contextual, alpha| {
	...
	objects = KernelObjectPlan.Plan.build(tagged, colors, images, resource_use, content, KernelObjectPlan.Limits.make({ max_objects: 16, max_pages: 1 })) ? ObjectPlanFailure
