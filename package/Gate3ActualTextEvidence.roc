...
build_multi_face_sample = |_| {
	...
	base_objects = KernelGate2Objects.Plan.build_with_text(tagged, colors, images, resource_use, content, KernelGate2Objects.Limits.make({ max_objects: 48, max_pages: 1 })) ? |_| EvidenceFailure
	font_objects = KernelGate3FontObjects.Plan.build(base_objects, 2, 48) ? |_| EvidenceFailure
	structure = KernelGate3TaggedTextStructure.Plan.build(
		...
		KernelGate3TaggedTextStructure.Limits.make({ font_limits: KernelPdfFont.Limits.make({ max_to_unicode_bytes: 2048, max_unicode_mappings: 8, max_unicode_scalars: 8 }), object_limits: multi_face_object_limits }),
	) ? |_| EvidenceFailure
