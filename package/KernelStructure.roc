...
KernelStructure :: [].{
	...
	Plan :: {
		identity : [Blank, GeneratedContentDigest(List(U8)), UnchangedContentDigest(List(U8))],
		output_bound : U64,
		page_count : U64,
		page_size : PageSize,
		...
		identity : Plan -> [Blank, GeneratedContentDigest(List(U8)), UnchangedContentDigest(List(U8))]
