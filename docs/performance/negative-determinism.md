# structural-kernel negative and cross-system evidence

## Atomic negative matrix

structural-kernel invalid inputs are rejected at their typed construction or sealing
...
The shared snapshots establish these structural-kernel hashes on both systems:
