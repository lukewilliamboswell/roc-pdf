# Gate 3 advanced supplementary-plane text slice

This slice closes the supplementary-plane row of the Gate 3 advanced shaped-run
...
```sh
./scripts/test.py --case 'Gate 3 supplementary-plane searchable text' --case 'Gate 3 supplementary-plane text atomic negative'
python3 scripts/check_gate3_supplementary_text.py --pdfbox-extraction
python3 scripts/check_gate3_renderers.py --supplementary --pdfium-renderer /home/lbw/.local/bin/pdfium-render
```
...
still block Gate 3 closure. The public and caller-facade baseline promotion
