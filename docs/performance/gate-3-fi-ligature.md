# Gate 3 parsed `fi` ligature output

This closes the ligature row of the Gate 3 extraction/rendering matrix only.
...
sanitized subset. Gate 3 remains open for its other criteria.
