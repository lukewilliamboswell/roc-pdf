# text-layout caller-font text slice

This slice routes the public caller-font boundary through the existing text-layout
...
resource plans, prepared local-coordinate run, tagged content stream, tagged-visual
