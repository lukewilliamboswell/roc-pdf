# tagged-visual content lowering
...
tagged-visual currently admits one page content stream per page. The semantic and
...
content bytes, and 131 total Roc allocations while reusing one image payload.
