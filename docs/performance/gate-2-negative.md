# Gate 2 atomic negative evidence
...
`check_gate2.py` begins from the retained valid PDF and applies five length-
...
Gate 1 structural negatives separately prove that offsets, lengths, xref,
