...
family: catalog, structure root, ParentTree, namespaces, structure elements,
balanced page-tree nodes, page/content pairs, ICC profile streams, color-space
objects, image streams, and optional alpha-mask streams. The xref stream follows
the stored object range and is not counted as a stored object.
