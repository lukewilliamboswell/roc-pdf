# Gate 3 `roc-lang/unicode` 4.0.0 adoption record
...
- The dependency continues to report Unicode 17.0.0, UAX #9 revision 51,
  ...
  registered `gate3_unicode_vectors` seam evidence remains valid unchanged.
...
`gate-3-rtl-blocker.md` (`roc-lang/unicode#39`) and
`gate-3-case-transformation-blocker.md` (`roc-lang/unicode#52`); their
