# tagged-visual independent renderer evidence

## Fixture and oracle

The retained tagged-visual PDF is rendered at 720 dpi by PDFium Chromium 7988 and
...
which `check_visual_renderers.py` parses without image-library dependencies.
