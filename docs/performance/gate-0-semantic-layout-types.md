# Gate 0 semantic, layout, and scene type slice
...
scaled-work baselines begin with the gates implementing these stores and
algorithms, as required for define-only Gate 0 capabilities by the roadmap.
