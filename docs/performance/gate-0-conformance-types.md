...
Executable allocation and scaling evidence begins with the gate that performs
validation. This Gate 0 slice is checked through type checking and unit tests,
