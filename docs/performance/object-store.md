# structural-kernel flat object-store slice
...
structural-kernel now has sealing-time reference validation, compact emission-plan
...
object lowerers consume this completed kernel at their roadmap stages.
