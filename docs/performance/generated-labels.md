# text-layout generated list-label slice
...
This closes only the generated-label row of text-layout's extraction matrix. It does
not close text-layout; ligature, supplementary-plane, RTL, CJK, hyphen behavior,
case transformations, and the remaining text-layout audit/evidence remain open.
