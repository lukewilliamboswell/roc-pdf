...
| Pinned UAX #14/UAX #29 fixtures, including version-sensitive boundaries | Partial | The package pin records UAX 14 rev. 55 and UAX 29 rev. 47 in `conformance/normative-baseline.json:107-131`; source/cache and line-layout slices consume the resulting facts. | No project-owned, registered Gate 3 fixtures for the official/version-sensitive UAX #14 and UAX #29 boundary vectors were found. The roadmap makes this explicit evidence, not a dependency-version assertion (`feature-roadmap.md:467-469`). |
